...
namespace CrudSample.Views.Anagrafiche.Truck
{
    ...
    public sealed partial class TruckCrudPage : Page
    {
        ...
        private void navigationHelper_LoadState(object sender, LoadStateEventArgs e)
        {
            ...
            if (Truck != null)
            {
                truckForm.trId = Truck.trId.ToString();
                truckForm.trName = Truck.trName;
                truckForm.trCode = Truck.trCode;
                truckForm.trUrl = Truck.trUrl;
        ...
        private void Btn_SaveTruck(object sender, RoutedEventArgs e)
        {

        }

        private async void provasasa(object sender, EventArgs e)
        {
            var msgDlg = new Windows.UI.Popups.MessageDialog("SI PUO FAREEE");
